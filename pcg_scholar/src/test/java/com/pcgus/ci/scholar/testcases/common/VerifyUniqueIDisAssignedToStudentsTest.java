...
public class VerifyUniqueIDisAssignedToStudentsTest extends Base {
	
	private static final String TEST_ID="jeyanyrz4cnqwb5dckumeu7gmajxh52s";
	...
	@Test
	public void verifyuniqueidisassignedtostudents_jeyanyrz4cnqwb5dckumeu7gmajxh52s() throws InterruptedException, AWTException {
		...
		applicationpage.verifySearchedValue("1","3", lastName);
		extentTest.log(LogStatus.PASS, "Verified : Verified first name");

		applicationpage.verifySearchedValue("1","4", firstName);
		extentTest.log(LogStatus.PASS, "Verified : Verified last name");

//		applicationpage.verifySearchedValue("1","6", dob);
//		extentTest.log(LogStatus.PASS, "Verified : Verified DOB");

		applicationpage.clickOnSearchedValue("1","3");
		extentTest.log(LogStatus.PASS, "Verified : Cliked on user");
