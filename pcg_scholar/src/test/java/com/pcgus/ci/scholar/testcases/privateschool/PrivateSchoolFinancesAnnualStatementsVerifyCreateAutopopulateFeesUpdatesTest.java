...
public class PrivateSchoolFinancesAnnualStatementsVerifyCreateAutopopulateFeesUpdatesTest extends Base {

    private static final String TEST_ID = "zkkiijbtvo464bogwjuju6o74b36wjaz";
    ...
    @Test
    public void school_finance_annualstatement_createandsubmitstatement_Autopopulate_zkkiijbtvo464bogwjuju6o74b36wjaz_test() throws InterruptedException {
        setTestId(TEST_ID);
        ...
        admiralpage.clickOnAutopopulate();
        extentTest.log(LogStatus.PASS, "Verified: Successfully clicked on Autopopulate Button");
