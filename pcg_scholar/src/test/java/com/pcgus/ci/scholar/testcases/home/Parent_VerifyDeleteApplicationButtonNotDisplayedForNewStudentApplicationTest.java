...
public class Parent_VerifyDeleteApplicationButtonNotDisplayedForNewStudentApplicationTest extends Base {
    ...
    @Test
    public void parent_verifydeleteapplicationbuttonnotdisplayedfornewstudentapplication_zs56vsj4qwbcyvgqwctk4jcoqp6n4j7o() throws InterruptedException {

        setTestId(TEST_ID);
        BrowserDriver.setDriver(Base.driver);

        extentTest.log(LogStatus.INFO, "TC Summary : Parent - Verify  Delete application button should not be displayed for new student complete application form in parent portal #SHIP-1223");
